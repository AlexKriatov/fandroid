package com.example.a5androidintern1.p0951_servicebackpendingintent;
...
public class MainActivity extends Activity {
    ...
    public void onClickStart(View v) {
        ...
        pi = createPendingResult(TASK1_CODE, intent = new Intent(), 0);
        ...
        pi = createPendingResult(TASK2_CODE, intent = new Intent(), 0);
        intent = new Intent(this, MyService.class).putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_PINTENT, pi);
        startService(intent);

        pi = createPendingResult(TASK3_CODE, intent = new Intent(), 0);
